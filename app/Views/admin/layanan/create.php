    ...
    <div class="col-xl-8 col-lg-8 col-md-6 col-sm-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('dashboard/layanan/save'); ?>" method="post">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?= user_id(); ?>">

                    <div class="form-group mb-4">
                        <label for="nama_layanan">Nama Layanan <span class="text-danger">*</span></label>
                        <input type="text" class="form-control <?= session('errors.nama_layanan') ? 'is-invalid' : ''; ?>" id="nama_layanan" placeholder="Masukan Nama Layanan" name="nama_layanan" value="<?= old('nama_layanan'); ?>">
