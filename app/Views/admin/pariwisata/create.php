    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('dashboard/pariwisata/save'); ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <a href="<?= base_url('dashboard/pariwisata'); ?>" type="button" class="btn btn-danger w-100">Batal</a>
                                </div>
                                <div class="col-6">
