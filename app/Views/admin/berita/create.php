    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('dashboard/berita/save'); ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xl-8 col-lg-7 col-md-6">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.judul') ? 'is-invalid' : ''; ?>" id="judul" placeholder="Masukan Judul" name="judul" value="<?= old('judul'); ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control cke-editor-form <?= session('errors.deskripsi') ? 'is-invalid' : ''; ?>" id="deskripsi" placeholder="Masukan Isi Berita" name="deskripsi" rows="4"><?= old('deskripsi'); ?></textarea>
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-select <?= session('errors.kategori_id') ? 'is-invalid' : ''; ?>" id="kategori_id" name="kategori_id">
                                            <?php foreach ($kategori as $ktg) : ?>
                                                <option value="<?= $ktg['id']; ?>" <?= old('kategori_id') == $ktg['id'] ? 'selected' : ''; ?>><?= $ktg['kategori']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
                                            <i class="bx bx-radio-circle"></i>
