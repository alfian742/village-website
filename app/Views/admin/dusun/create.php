    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('dashboard/dusun/save'); ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xl-8 col-lg-7 col-md-6">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.nama_dusun') ? 'is-invalid' : ''; ?>" id="nama_dusun" placeholder="Masukan Nama Dusun/Lingkungan" name="nama_dusun" value="<?= old('nama_dusun'); ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control cke-editor-form <?= session('errors.deskripsi') ? 'is-invalid' : ''; ?>" id="deskripsi" placeholder="Masukan Deskripsi Dusun/Lingkungan (SDA, SDM dan lain sebagainya)" name="deskripsi" rows="4"><?= old('deskripsi'); ?></textarea>
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select <?= session('errors.kepala_dusun_id') ? 'is-invalid' : ''; ?>" id="kepala_dusun_id" name="kepala_dusun_id">
                                    <?php foreach ($kepala_dusun as $kd) : ?>
                                        <option value="<?= $kd['id']; ?>" <?= old('kepala_dusun_id') == $kd['id'] ? 'selected' : ''; ?>><?= $kd['nama']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.luas') ? 'is-invalid' : ''; ?>" id="luas" placeholder="Masukan Luas Dusun/Lingkungan" name="luas" value="<?= old('luas'); ?>">
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                                    <?= session('errors.luas') ?>
                                </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.timur') ? 'is-invalid' : ''; ?>" id="timur" placeholder="Batas Wilayah Timur" name="timur" value="<?= old('timur'); ?>">
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.barat') ? 'is-invalid' : ''; ?>" id="barat" placeholder="Batas Wilayah Barat" name="barat" value="<?= old('barat'); ?>">
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.selatan') ? 'is-invalid' : ''; ?>" id="selatan" placeholder="Batas Wilayah Selatan" name="selatan" value="<?= old('selatan'); ?>">
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= session('errors.utara') ? 'is-invalid' : ''; ?>" id="utara" placeholder="Batas Wilayah Utara" name="utara" value="<?= old('utara'); ?>">
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
