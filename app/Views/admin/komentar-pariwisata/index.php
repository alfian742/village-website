                        ...
                        <tbody>
                            <?php foreach ($komentar as $kmt) : ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div class="text-clamp-2"><?= $kmt['judul_pariwisata']; ?></div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="<?= base_url('pariwisata/' . $kmt['slug_pariwisata']); ?>" target="_blank" class="btn btn-success icon"><i class="bi bi-eye"></i></a>
                                            <form action="<?= base_url('dashboard/komentar-pariwisata/delete/') . $kmt['id']; ?>" method="post" class="d-inline">
                                                <?= csrf_field(); ?>
