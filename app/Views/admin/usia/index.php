    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('dashboard/usia/update'); ?>" method="post">
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="w-max-content" data-bs-toggle="tooltip" data-bs-title="Edit jumlah data">
                                                ...
                                                <input type="number" class="form-control" placeholder="Masukan Data" name="jumlah[]" value="<?= (old('jumlah')) ? old('jumlah') : $usa['jumlah']; ?>">
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
